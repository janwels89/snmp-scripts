...
# Origin https://github.com/echocat/nagios-plugin-check_mountpoints
...
# @version: 2.7
# @date: 2021-11-26
# Modified by Jan Welslau jan.welslau@gmail.com on 2025-11-12
#
# changes 3.0
#  - remove utils.sh dependency
# changes 2.7
...
# Standalone Nagios state codes (replaces utils.sh)
STATE_OK=0
STATE_WARNING=1
STATE_CRITICAL=2
STATE_UNKNOWN=3
